      ...
      <div className="bg-white p-6 rounded-3xl border border-slate-200/70 shadow-card flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-[#0e3e26] border border-emerald-200/80">
              ★ 4.8 Top Tier
            </span>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex gap-1 mt-1.5">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-4 h-4 text-emerald-600 fill-emerald-500" />
                ))}
              </div>
            </div>
            ...
            {distribution.map(d => (
              <div key={d.stars} className="flex items-center gap-2.5 text-xs">
                <span className="w-6 font-bold text-slate-600 flex items-center gap-0.5">
                  {d.stars} <Star className="w-3 h-3 text-emerald-600 fill-emerald-500" />
                </span>
