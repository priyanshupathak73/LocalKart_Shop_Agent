...
export const DeliverySignOutSection = () => {
  ...
  return (
    <div className="bg-red-50/50 dark:bg-red-950/20 border border-red-200/80 dark:border-red-800/60 rounded-2xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-left">
      <div className="flex items-center gap-3.5">
        ...
        <div>
          <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100 font-heading">Sign Out of Delivery Partner Account</h4>
          <p className="text-xs text-slate-500 dark:text-slate-400">Safely complete duty session and log out of this device</p>
        </div>
      </div>
